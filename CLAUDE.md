...
- `proposal_dev/` covers grant-proposal development, organized by year then proposal (`proposal_dev/proposals_<year>/<proposal_slug>/`, each proposal its own git repo; the year dir carries the `proposals_` prefix — bare `2026/` was judged regrettable, Dax 2026-07-22). Currently holds `proposals_2026/nsf26_512_ai_datasets` (NSF 26-512 "AI Datasets", deadline 2026-11-04) and `proposals_2026/grti26_seismic_expansion` (CUNY GRTI equipment request). Also `proposals_2026/seismic_geode_expansion` — the superseded June-2026 $10k dean-memo seed for the GRTI ask, kept for its owned-gear inventory and pricing history; **[iMac]-local git with no remote**, moved into the year dir 2026-08-01.
